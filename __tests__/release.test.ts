...
test('release event to slack', async () => {
  ...
  expect(JSON.parse(mockAxios.history.post[0].data)).toStrictEqual({
    ...
    attachments: [
      {
        fallback: '[GitHub]: [step-security/act10ns-slack] build-test release Success',
        color: 'good',
        ...
        pretext: '',
        text: '*<https://github.com/step-security/act10ns-slack/actions?query=workflow:%22build-test%22|Workflow _build-test_ job _Build and Test_ triggered by _release_ is _Success_>* for <https://github.com/step-security/act10ns-slack/commits/refs/tags/v1.0.13|`refs/tags/v1.0.13`>\n',
        title: '',
        fields: [],
        footer: '<https://github.com/step-security/act10ns-slack|step-security/act10ns-slack> #817',
