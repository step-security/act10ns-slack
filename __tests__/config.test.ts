    ...
    attachments: [
      {
        ...
        text:
          '*<https://github.com/step-security/act10ns-slack/actions/runs/100143423|Workflow _build-test_ job _CI Tests_ triggered by _push_ is _failure_>* for <https://github.com/step-security/act10ns-slack/commits/master|`master`>\n' +
        ...
        fields: [
          ...
          },
          {
            short: true,
            title: 'Workflow',
            value: '<https://github.com/step-security/act10ns-slack/actions?query=workflow:%22build-test%22|build-test>'
          },
          {
            short: true,
            title: 'Git Ref',
          ...
          },
          {
            short: true,
            title: 'Run ID',
            value: '<https://github.com/step-security/act10ns-slack/actions/runs/100143423|100143423>'
          },
          {
            short: true,
            title: 'Run Number',
