...
const url = 'https://hooks.slack.test/services/T00000000/B00000000/XXXXXXXXXXXXXXXXXXXXXXXX'
...
process.env.GITHUB_ACTOR = 'step-security'
process.env.GITHUB_REPOSITORY = 'step-security/act10ns-slack'
    ...
    attachments: [
      {
        ...
        color: '#884EA0',
        pretext: 'Triggered via push by step-security action master `68d48876`',
        author_name: 'step-security',
        author_link: 'https://github.com/step-security',
        author_icon: 'https://avatars0.githubusercontent.com/u/615057?v=4',
        title: 'GitHub Actions',
        title_link: 'https://support.github.com',
        text: '*<https://github.com/step-security/act10ns-slack/actions/runs/100143423|Workflow _build-test_ job _CI Tests_ triggered by _push_ is _failure_>* for <https://github.com/step-security/act10ns-slack/commits/master|`master`>\n<https://github.com/step-security/act10ns-slack/compare/db9fe60430a6...68d48876e079|`68d48876`> - 4 commits\n*Commits*\n<https://github.com/step-security/act10ns-slack/commit/b1f512300ea6e925e095c51a441fcf30104523aa|`b1f51230`> - wip\n<https://github.com/step-security/act10ns-slack/commit/b246b5fdcc2722909503d5a43eb635885aa5fd25|`b246b5fd`> - wip\n<https://github.com/step-security/act10ns-slack/commit/553c22356fadc36947653de987dabd8da40cb06b|`553c2235`> - wip\n<https://github.com/step-security/act10ns-slack/commit/68d48876e0794fba714cb331a1624af6b20942d8|`68d48876`> - wip\n',
        fields: [
          {
            title: 'Job Steps',
        ...
        footer: '<https://github.com/step-security/act10ns-slack|step-security/act10ns-slack> build-test #8',
        ...
        blocks: [
          {
            ...
            elements: [
              {
                type: 'image',
                image_url: 'https://avatars0.githubusercontent.com/u/615057?v=4',
                alt_text: 'step-security'
              },
              {type: 'mrkdwn', text: '*<https://github.com/step-security|step-security>*'}
            ]
          },
          ...
          },
          {
            ...
            fields: [
              {
                type: 'mrkdwn',
                text: '*Workflow*\n<https://github.com/step-security/act10ns-slack/actions?query=workflow:%22build-test%22|build-test>'
              },
              {type: 'mrkdwn', text: '*Git Ref*\nmaster (branch)'},
              {
                type: 'mrkdwn',
                text: '*Run ID*\n<https://github.com/step-security/act10ns-slack/actions/runs/100143423|100143423>'
              },
          ...
          },
          {
            type: 'context',
            elements: [
              {type: 'image', image_url: 'https://github.githubassets.com/favicon.ico', alt_text: 'step-security'},
              {
                type: 'mrkdwn',
