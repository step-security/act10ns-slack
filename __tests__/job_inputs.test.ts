...
test('push event to slack', async () => {
  ...
  expect(JSON.parse(mockAxios.history.post[0].data)).toStrictEqual({
    ...
    attachments: [
      {
        fallback: '[GitHub]: [step-security/act10ns-slack] build-test push Success',
        color: 'good',
        ...
        pretext: '',
        text: '*<https://github.com/step-security/act10ns-slack/actions?query=workflow:%22build-test%22|Workflow _build-test_ job _Build and Test_ triggered by _push_ is _Success_>* for <https://github.com/step-security/act10ns-slack/commits/master|`master`>\n<https://github.com/step-security/act10ns-slack/compare/db9fe60430a6...68d48876e079|`68d48876`> - 4 commits',
        title: '',
        fields: [
          {
            title: 'Job Inputs',
        ...
        footer: '<https://github.com/step-security/act10ns-slack|step-security/act10ns-slack> #8',
