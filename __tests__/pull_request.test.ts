...
test('pull request event to slack', async () => {
  ...
  expect(JSON.parse(mockAxios.history.post[0].data)).toStrictEqual({
    ...
    attachments: [
      {
        fallback: '[GitHub]: [step-security/act10ns-slack] build-test pull_request opened Success',
        color: 'good',
        ...
        pretext: '',
        text: '*<https://github.com/step-security/act10ns-slack/actions?query=workflow:%22build-test%22|Workflow _build-test_ job _Build and Test_ triggered by _pull_request_ is _Success_>* for <https://github.com/step-security/act10ns-slack/pull/17|`#17`>\n<https://github.com/step-security/act10ns-slack/pull/17/files|`rename-to-slack`> - Rename to slack',
        title: '',
        fields: [],
        footer: '<https://github.com/step-security/act10ns-slack|step-security/act10ns-slack> #760',
