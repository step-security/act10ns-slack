...
process.env.SLACK_WEBHOOK_URL = 'https://hooks.slack.test/services/T00000000/B00000000/XXXXXXXXXXXXXXXXXXXXXXXX'
    ...
    attachments: [
      {
        ...
        color: '#5DADE2',
        pretext: 'Triggered via workflow_run by step-security __act10ns_slack master `0d05b90e`',
        ...
        text: '*<https://github.com/step-security/act10ns-slack/actions?query=workflow:%22workflow-run%22|Workflow _workflow-run_ job _on-success_ triggered by _workflow_run_ is _SUCCESS_>* for <https://github.com/step-security/act10ns-slack/commits/master|`master`>\n',
        fields: [],
        fallback: '[GitHub] workflow-run #4 is SUCCESS',
        footer: '<https://github.com/step-security/act10ns-slack|step-security/act10ns-slack> workflow-run #4',
        ...
        blocks: [
          {
            ...
            elements: [
              {
                type: 'image',
                image_url: 'https://avatars.githubusercontent.com/u/615057?v=4',
          ...
          },
          {
            ...
            accessory: {
              ...
              url: 'https://github.com/step-security/act10ns-slack/actions/runs/1452342609',
          ...
          },
          {
            ...
            fields: [
              {
                type: 'mrkdwn',
                text: '*Jobs*\nhttps://api.github.com/repos/step-security/act10ns-slack/actions/runs/1452342609/jobs'
              },
              {
                type: 'mrkdwn',
                text: '*Logs*\nhttps://api.github.com/repos/step-security/act10ns-slack/actions/runs/1452342609/logs'
              }
            ]
          },
          {
