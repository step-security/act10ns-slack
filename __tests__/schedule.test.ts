...
test('schedule event to slack', async () => {
  ...
  expect(JSON.parse(mockAxios.history.post[0].data)).toStrictEqual({
    ...
    attachments: [
      {
        fallback: '[GitHub]: [step-security/act10ns-slack] schedule-test schedule Success',
        color: 'good',
        author_name: 'github',
        ...
        pretext: '',
        text: '*<https://github.com/step-security/act10ns-slack/actions?query=workflow:%22schedule-test%22|Workflow _schedule-test_ job _Build and Test_ triggered by _schedule_ is _Success_>* for <https://github.com/step-security/act10ns-slack/commits/master|`master`>\n<https://github.com/step-security/act10ns-slack/commit/09a6b2c9|`09a6b2c9`> - Schedule `*/15 * * * *`',
        title: '',
        fields: [],
        footer: '<https://github.com/step-security/act10ns-slack|step-security/act10ns-slack> #179',
